...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link CustomQuakeInfo} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<CustomQuakeInfo> extractEarthquakes(String rootStr) {
        ...
        try {
            ...
            for(int i = 0;i<featureArray.length();i++)
            {
                ...
                earthquakes.add(new CustomQuakeInfo(decimalMagnitude, place, date, time,url));
            }
...
//From quake report
    ...
    /**
     * Query the USGS dataset and return an {@link List<CustomQuakeInfo>} object to represent a single earthquake.
     */
    public static ArrayList<CustomQuakeInfo> fetchEarthquakeData(String requestUrl) {
        // Create URL object
        ...
        ArrayList<CustomQuakeInfo> earthquake = extractEarthquakes(jsonResponse);
